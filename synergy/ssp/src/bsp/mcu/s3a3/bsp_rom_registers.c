 ...
 * @defgroup BSP_MCU_ROM_REGISTER_S3A3 ROM Registers
 *
...
BSP_DONT_REMOVE static const uint32_t g_bsp_rom_registers[] BSP_PLACE_IN_SECTION_V2(BSP_SECTION_ROM_REGISTERS) =
{
    ...
    (((uint32_t)BSP_CFG_ROM_REG_MPU_REGION0_END   & 0x00FFFFFFU) | 0x00000003U),
...
/** @} (end defgroup BSP_MCU_ROM_REGISTER_S3A3) */
